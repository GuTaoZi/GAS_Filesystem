...
int gas_readpages(struct file *file, struct address_space *mapping, struct list_head *pages, unsigned nr_pages)
{
    return mpage_readpages(mapping, pages, nr_pages, gas_get_block);
}

ssize_t gas_direct_io(int rw, struct kiocb *iocb, const struct iovec *iov, loff_t off, unsigned long nr_segs)
{
...
int gas_write_begin(struct file *file, struct address_space *mapping, loff_t pos, unsigned len, unsigned flags,
...
int gas_write_end(struct file *file, struct address_space *mapping, loff_t pos, unsigned len, unsigned copied,
