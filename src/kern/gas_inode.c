...
void gas_inode_fill(struct gas_inode_info *info, struct gas_inode const *gnode)
{
    int i;
    ...
    info->inode.i_mtime.tv_nsec = info->inode.i_atime.tv_nsec = info->inode.i_ctime.tv_nsec = 0;
